import { c as Ke, _ as za, g as _o } from "./index-DaDQdYeh.js";
var vt = function (a) {
...
var Ti = function (a, e) {
  ...
  fr;
xn &&
  ((ue = xn.split(".")), (fr = ue[0] > 0 && ue[0] < 4 ? 1 : +(ue[0] + ue[1])));
!fr &&
  Jr &&
  ((ue = Jr.match(/Edge\/(\d+)/)),
  (!ue || ue[1] >= 74) &&
...
var Oi = fr,
  ...
  Wl = Go,
  zo = Wl && !Symbol.sham && typeof Symbol.iterator == "symbol",
  ql = Fe,
  Ql = B,
  Kl = br,
  Zl = zo,
...
var Ei = Yo.exports,
  ...
  Ze = xh.Symbol,
  aa = Th("wks"),
  $h = Eh ? Ze.for || Ze : (Ze && Ze.withoutSetter) || Oh,
  z = function (a) {
    return (
      wn(aa, a) || (aa[a] = Sh && wn(Ze, a) ? Ze[a] : $h("Symbol." + a)), aa[a]
    );
  },
  wh = Y,
  Cn = ve,
...
var iv = le,
  ...
  wi = ov(Zo, "name"),
  lv = wi && function () {}.name === "something",
  hv = wi && (!Xa || (Xa && uv(Zo, "name").configurable)),
  Sr = { EXISTS: wi, PROPER: lv, CONFIGURABLE: hv },
  vv = L,
  fv = B,
  Wa = Ei,
...
var Ci = Wa.inspectSource,
  gv = V,
  dv = B,
  In = gv.WeakMap,
  pv = dv(In) && /native code/.test(String(In)),
  yv = $i,
  mv = Xo,
  Mn = yv("keys"),
  Ai = function (a) {
...
var Er = { set: cr, get: Ot, has: gr, enforce: $v, getterFor: wv },
  Ri = L,
  Cv = k,
  Av = B,
  zt = fe,
  ...
  kv = String(String).split("String"),
  Lv = (Ko.exports = function (a, e, t) {
    Mv(Vn(e), 0, 7) === "Symbol(" &&
      (e = "[" + _v(Vn(e), /^Symbol\(([^)]*)\).*$/, "$1") + "]"),
      t && t.getter && (e = "get " + e),
      t && t.setter && (e = "set " + e),
      (!zt(a, "name") || (Pv && a.name !== e)) &&
    ...
    var r = Nv(a);
    return (
      zt(r, "source") || (r.source = Vv(kv, typeof e == "string" ? e : "")), a
    );
  });
...
var vf = Fe,
  ...
  ee = function (a, e) {
    ...
    if (
      ...
      for (s in e) {
        if (
          ((l = e[s]),
          a.dontCallGetSet ? ((h = Pf(o, s)), (u = h && h.value)) : (u = o[s]),
          (n = _f(r ? s : t + (i ? "." : "#") + s, a.forced)),
          !n && u !== void 0)
        ) {
    ...
    ("__proto__" in {}
      ? (function () {
          var a = !1,
            ...
            t;
          try {
            (t = Xf(Object.prototype, "__proto__", "set")),
              t(e, []),
  ...
  Cr = function (a, e, t) {
    a && !t && (a = a.prototype),
      a && !Zf(a, Bn) && Kf(a, Bn, { configurable: !0, value: e });
  },
  jn = tu,
  ec = Oe,
  tc = function (a, e, t) {
...
var Cc =
  ...
  Uc = Fe,
  yu = Uc("document", "documentElement"),
  Gc = L,
  zc = Gc([].slice),
  Hc = TypeError,
  Yc = function (a, e) {
  ...
  Xc = Ct,
  mu = /(?:ipad|iphone|ipod).*applewebkit/i.test(Xc),
  ae = V,
  Wc = pu,
  qc = Vi,
  Yn = B,
...
(!Ka || !Za) &&
  ...
  eg
    ...
    ? ((ca = new qn()),
      (ga = ca.port2),
      (ca.port1.onmessage = Kn),
      (Ie = qc(ga.postMessage, ga)))
    : ae.addEventListener &&
      Yn(ae.postMessage) &&
      !ae.importScripts &&
      St &&
      St.protocol !== "file:" &&
      !bu(Zn)
    ? ((Ie = Zn), ae.addEventListener("message", Kn, !1))
    : Qn in Wn("script")
    ? (Ie = function (a) {
...
var Ou = Tu,
  og = Ct,
  ug = /ipad|iphone|ipod/i.test(og) && typeof Pebble < "u",
  lg = Ct,
  hg = /web0s(?!.*chrome)/i.test(lg),
  it = V,
  vg = sg,
  es = Vi,
  pa = xu.set,
  ...
  dg = hg,
  ya = wr,
  ts = it.MutationObserver || it.WebKitMutationObserver,
  rs = it.document,
  as = it.process,
  Xt = it.Promise,
  Ja = vg("queueMicrotask"),
  Xe,
  ma,
  ba,
  Wt,
...
if (!Ja) {
  ...
  !cg && !ya && !dg && ts && rs
    ? ((ma = !0),
      (ba = rs.createTextNode("")),
      new ts(Qt).observe(ba, { characterData: !0 }),
      (Xe = function () {
        ba.data = ma = !ma;
      }))
    : !gg && Xt && Xt.resolve
...
var Eg = Sg("species"),
  ei = !1,
  Su = xg(bg.PromiseRejectionEvent),
  $g = Tg("Promise", function () {
    var a = Og(Tt),
      e = a !== String(Tt);
    if (!e && xa === 66) return !0;
    if (!xa || xa < 51 || !/native code/.test(a)) {
      var t = new Tt(function (n) {
        ...
        i = (t.constructor = {});
      if (((i[Eg] = r), (ei = t.then(function () {}) instanceof r), !ei))
        return !0;
    }
    return !e && (ns === "BROWSER" || ns === "DENO") && !Su;
  }),
  Rt = { CONSTRUCTOR: $g, REJECTION_EVENT: Su, SUBCLASSING: ei },
  lt = {},
  ss = Te,
  wg = TypeError,
  Cg = function (a) {
...
var Ag = ee,
  ...
  ri = wu.f,
  Fg = ri,
  Ug = !!(ti && ti.createEvent && we.dispatchEvent),
  ...
  Mu = function (a, e) {
    ...
    try {
      i
        ? (r || (e.rejection === Nu && Xg(e), (e.rejection = Fi)),
          i === !0
            ? (u = t)
            : (s && s.enter(), (u = i(t)), s && (s.exit(), (h = !0))),
          u === a.promise
            ? o(new Au("Promise-chain cycle"))
            : (l = Iu(u))
            ? nt(l, u, n, o)
            : n(u))
        : o(t);
  ...
  Vu = function (a, e, t) {
    ...
    Ug
      ...
      !Lg && (i = we["on" + a])
        ? i(r)
        : a === Pu && Vg("Unhandled promise rejection", t);
  },
  Yg = function (a) {
    nt(Eu, we, function () {
      var e = a.facade,
  ...
  tt = function (a, e, t) {
    a.done ||
      ((a.done = !0), t && (a = t), (a.value = e), (a.state = zg), _u(a, !0));
  },
  ai = function (a, e, t) {
    if (!a.done) {
      (a.done = !0), t && (a = t);
...
Ag({ global: !0, constructor: !0, wrap: !0, forced: Cu }, { Promise: De });
Pg(De, Rr, !1);
Rg(Rr);
var Nt = {},
  Wg = z,
...
var $d = function (a, e) {
  ...
  Vd = ju;
Pd(
  { target: "Promise", stat: !0, forced: Vd },
  {
    all: function (e) {
      var t = this,
        r = Id.f(t),
...
var Dd = ee,
  ...
  bs = ii && ii.prototype;
Dd(
  { target: "Promise", proto: !0, forced: kd, real: !0 },
  {
    catch: function (a) {
...
var np = Mi,
  ...
  Uu = { BROKEN_CARET: hp, MISSED_STICKY: lp, UNSUPPORTED_Y: zi },
  Gu = {},
  vp = iu,
  fp = Ii,
  cp =
...
var xp = J,
  ...
  hr = function () {
    ...
    hr =
      typeof document < "u" ? (document.domain && Jt ? $s(Jt) : wp()) : $s(Jt);
...
var Hi =
    ...
    function (e, t) {
      ...
      return (
        e !== null
          ? ((Oa[ni] = xp(e)), (r = new Oa()), (Oa[ni] = null), (r[zu] = e))
          : (r = hr()),
        t === void 0 ? r : Tp.f(r, t)
      );
    },
...
`) &&
  ...
  Fp = Rp,
  Up = _p,
  Gp = Lp("native-string-replace", String.prototype.replace),
...
`)) &&
      ...
      d
        ? l
          ...
          : (t.lastIndex = 0)
        : ui && l && (t.lastIndex = t.global ? l.index + l[0].length : u),
      li &&
        l &&
        l.length > 1 &&
        et(Gp, l[0], s, function () {
...
var Yi = oi,
  Wp = ee,
  ws = Yi;
Wp({ target: "RegExp", proto: !0, forced: /./.exec !== ws }, { exec: ws });
var Cs = Y,
  As = Ue,
  qp = Yi,
  Ps = k,
    ...
    if (!n || !o || t) {
      var s = /./[i],
        u = e(i, ""[a], function (l, h, f, c, v) {
          var d = h.exec;
          return d === qp || d === Ea.exec
            ? n && !v
              ? { done: !0, value: Cs(s, h, f, c) }
              : { done: !0, value: Cs(l, f, h, c) }
            : { done: !1 };
        });
...
var Ki = L,
  ...
  Ty = /\$([$&'`]|\d{1,2}|<[^>]*>)/g,
  Oy = /\$([$&'`]|\d{1,2})/g,
  Sy = function (a, e, t, r, i, n) {
    var o = t + a.length,
      s = r.length,
      u = Oy;
    return (
      i !== void 0 && ((i = my(i)), (u = Ty)),
      xy(n, u, function (l, h) {
        var f;
        switch (wa(h, 0)) {
          case "$":
...
var zy = ve,
  ...
  Qy = TypeError,
  Zi = function (a) {
    if (qy(a)) throw new Qy("The method doesn't accept regular expressions");
    return a;
  },
  Ky = z,
  Zy = Ky("match"),
...
Jy(
  { target: "String", proto: !0, forced: !um && !Wu },
  {
    startsWith: function (e) {
      var t = Ls(im(this));
      am(e);
      var r = rm(om(arguments.length > 1 ? arguments[1] : void 0, t.length)),
        i = Ls(e);
...
fi[vi] === void 0 && vm(fi, vi, { configurable: !0, value: hm(null) });
var fm = function (a) {
    fi[vi][a] = !0;
  },
  cm = k,
...
[].keys &&
  ((Ra = [].keys()),
  "next" in Ra
    ? ((Pa = js(js(Ra))), Pa !== Object.prototype && (ke = Pa))
    : (Qu = !0));
var wm =
  !Sm(ke) ||
  Tm(function () {
...
var Ku = { IteratorPrototype: ke, BUGGY_SAFARI_ITERATORS: Qu },
  ...
  Hm = function (a, e, t, r, i, n, o) {
    ...
    if (
      (v &&
        ...
        d !== Object.prototype &&
          d.next &&
          (Fs(d) !== Gs && (Us ? Us(d, Gs) : Dm(d[gt]) || Na(d, gt, zm)),
          Lm(d, u, !0))),
      Um &&
        i === dt &&
        f &&
      ...
      if (((g = { values: s(dt), keys: n ? c : s(zs), entries: s(Hs) }), o))
  ...
  Jm = qm(
    ...
    "Array",
    function (a, e) {
      Km(this, { type: tl, target: Xm(a), index: 0, kind: e });
    },
    function () {
      var a = Zm(this),
        e = a.target,
...
var e0 = {
  ...
  t0 = Or,
  Ia = t0("span").classList,
  Ws = Ia && Ia.constructor && Ia.constructor.prototype,
  r0 = Ws === Object.prototype ? void 0 : Ws,
  qs = V,
  rl = e0,
  a0 = r0,
  yt = Jm,
...
for (var Va in rl) al(qs[Va] && qs[Va].prototype, Va);
al(a0, "DOMTokenList");
function s0(a, e) {
...
var u0 = Te,
  ...
  b0 = m0 || !p0("reduce");
g0(
  { target: "Array", proto: !0, forced: b0 },
  {
    reduce: function (e) {
...
x0(
  { target: "String", proto: !0, forced: !P0 && !nl },
  {
    endsWith: function (e) {
      var t = to($0(this));
      E0(e);
    ...
    return [
      ...
      function (i, n) {
        ...
        for (var d = 0, g = 0, p = []; g < s.length; ) {
          c.lastIndex = qe ? 0 : g;
          var y = ao(c, qe ? La(s, g) : s),
            x;
          if (
            y === null ||
            (x = F0(D0(c.lastIndex + (qe ? g : 0)), s.length)) === d
          )
            g = V0(s, g, h);
          else {
...
if (!st || !Et) {
  ...
  (st = function (a) {
    ...
    return Me.push({ handle: ++no, callback: a, cancelled: !1 }), no;
  }),
    (Et = function (a) {
...
\v\f\r                　\u2028\u2029\uFEFF`,
  ...
  Z0 = { start: Fa(1), end: Fa(2), trim: Fa(3) },
  J0 = Sr.PROPER,
  eb = k,
  oo = ol,
  uo = "​᠎",
  ...
  ib = tb;
rb(
  { target: "String", proto: !0, forced: ib("trim") },
  {
    trim: function () {
      return ab(this);
    },
...
var sb = ee,
  ...
  hb = ul || !lb("indexOf");
sb(
  { target: "Array", proto: !0, forced: hb },
  {
    indexOf: function (e) {
...
var vb = ee,
  ...
  pb = fb("".indexOf);
vb(
  { target: "String", proto: !0, forced: !db("includes") },
  {
    includes: function (e) {
      return !!~pb(
        lo(gb(this)),
...
var yb = Be,
  ...
  ho = [1, 2];
bb(
  { target: "Array", proto: !0, forced: String(ho) === String(ho.reverse()) },
  {
    reverse: function () {
...
function Ua(a, e, t) {
  ...
  var s = mi([(e - n) / 2, (t - o) / 2], (-a.xRot / 180) * Ee),
    u = s[0],
    l = s[1],
        ...
        return m.ARC === s.type
          ? (function (h, f, c) {
              ...
              for (
                ...
                var C = fo(h.phi1, h.phi2, O / b),
                  I = fo(h.phi1, h.phi2, (O + 1) / b),
                  _ = I - C,
                ...
                var K = function (ne, ge) {
                  var Se = mi([ne * h.rX, ge * h.rY], h.xRot),
                    ze = Se[0],
                    Mt = Se[1];
...
`
              ...
              if (
                ...
                if (
                  ...
                  if (this.curNumber && this.curCommandType !== -1) {
                    ...
                    this.curArgs.push(h),
                      this.curArgs.length === wb[this.curCommandType] &&
  ...
  Nb = function (a) {
    var e = a.flags;
    return e === void 0 && !("flags" in mo) && !Ab(a, "flags") && Pb(mo, a)
      ? Cb(Rb, a)
      : e;
  },
  Ib = Sr.PROPER,
...
function zb(a, e, t, r, i, n) {
  ...
  v.next = c;
  for (
    var p = null, y = null, x = 0, b = 0, T = jb[n], $ = Fb[n], E = 0;
    E < i;
    E++
  ) {
    v = c;
...
var i2 = Object.freeze({ __proto__: null, offscreen: Hb, node: Yb });
function ht(a) {
...
var Zb = /(\[[^\]]+\])/g,
  Jb = /(#[^\s+>~.[:]+)/g,
  e1 = /(\.[^\s+>~.[:]+)/g,
  t1 = /(::[^\s+>~.[:]+|:first-line|:first-letter|:before|:after)/gi,
  r1 = /(:[\w-]+\([^)]*\))/gi,
  a1 = /(:[^\s+>~.[:]+)/g,
  i1 = /([^\s+>~.[:]+)/g;
function _e(a, e) {
  ...
  getColor(e) {
    ...
    return (
      this.isNormalizedColor ||
        ((this.isNormalizedColor = !0), (t = Kb(t)), (this.value = t)),
      t
    );
  }
  getDpi() {
...
_r.defaultWindow = dl;
_r.defaultFetch = pl;
var { defaultFetch: u1 } = _r,
  l1 = typeof DOMParser < "u" ? DOMParser : null;
class Ga {
  constructor() {
    var { fetch: e = u1, DOMParser: t = l1 } =
      arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
...
class j1 extends Ce {
  ...
  getPointOnCubicBezier(e, t, r, i, n, o, s, u, l) {
    var h = u * So(e) + o * Eo(e) + i * $o(e) + t * wo(e),
      f = l * So(e) + s * Eo(e) + n * $o(e) + r * wo(e);
    return { x: h, y: f };
  }
  getPointOnQuadraticBezier(e, t, r, i, n, o, s) {
    var u = o * Co(e) + i * Ao(e) + t * Po(e),
      l = s * Co(e) + n * Ao(e) + r * Po(e);
    return { x: u, y: l };
  }
...
class $e {
  ...
  setViewBox(e) {
    this.screen.setViewBox(e2({ document: this }, e));
  }
}
$e.createCanvas = t2;
$e.createImage = r2;
